...
- (void)viewDidLoad
{
    ...
    itemArray = [[NSArray arrayWithObjects:
                  ...
                  [NSDictionary dictionaryWithObjectsAndKeys:@"知足", @"song", @"杨培安", @"artise", @"http://y1.eoews.com/assets/ringtones/2012/5/17/34016/eeemlurxuizy6nltxf2u1yris3kpvdokwhddmeb0.mp3", @"url", nil],
                  [NSDictionary dictionaryWithObjectsAndKeys:@"桔子香水", @"song", @"任贤齐", @"artise", @"http://www.baomanyu.com/images/woxiangxin.mp3", @"url", nil],
                  
                 nil] retain];
    //http://www.baomanyu.com/images/woxiangxin.mp3
    //http://y1.eoews.com/assets/ringtones/2012/6/29/36195/mx8an3zgp2k4s5aywkr7wkqtqj0dh1vxcvii287a.mp3
}
